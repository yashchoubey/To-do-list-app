...
\begin{figure}[ht!]
\centering
\includegraphics[width= 80mm,height=60mm]{anjul.jpg}
\end{figure}
\newpage 
...
\begin{figure}[ht!]
\centering
\includegraphics[width= 80mm,height=60mm]{final1_block.jpg}
\end{figure} 
\begin{figure}[ht!]
\centering
\includegraphics[width= 80mm,height=60mm]{choubey.jpg}
\end{figure} 
\newpage
\textbf{Tools Used :}
\begin{enumerate}
...
\begin{figure}[ht!]
\centering
\includegraphics[width= 80mm,height=60mm]{sc1.png}
\end{figure} 
\newpage
The spectrogram of the following data looks like this.
\begin{figure}[ht!]
\centering
\includegraphics[width= 80mm,height=60mm]{sc1-1.png}
\end{figure} 
\newpage
